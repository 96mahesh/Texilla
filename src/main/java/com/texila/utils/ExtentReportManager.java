...
public class ExtentReportManager {
	...
	public static void startReport()
	{
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/Reports/"+dateStamp+"/"+"Texilla"+timeStamp+".html");
...
*/	
		...
		extent.setSystemInfo("user_name", "Mahesh");
		spark.config().setDocumentTitle("Texila_html_Report");
		spark.config().setReportName("Texila_html_Report");
